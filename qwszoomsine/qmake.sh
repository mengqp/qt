...
$QMAKE -project -Wall  -o  qwszoomsine.pro -after "TARGET=qwszoomsine" $CONFIG  "OBJECTS_DIR = build/obj" "MOC_DIR = build/moc"  "QT += gui core network"
$QMAKE -makefile qwszoomsine.pro   -o Makefile
